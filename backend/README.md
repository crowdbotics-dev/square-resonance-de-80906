...
## Project Structure
    ...
    ├── square_resonance_de_80906  # Django project configurations
...
1. Clone this repo and `cd square_resonance_de_80906`
...
2. Clone this repo and `cd square_resonance_de_80906`
